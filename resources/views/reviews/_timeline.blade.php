                                ...
                                <button type="submit" class="p-review-list__button--favorite">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 77.479 62.172">
                                        <path
                                            ...
                                            style="fill:currentColor;fill-opacity:1;stroke:none;stroke-width:5;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none;stroke-opacity:1"
                                            transform="translate(-53.281 -115.818)" />
                                    </svg>
                                </button>
                            </form>
